const Watermark = ({ className = '' }) => {
  return (
    <div className={cn('font-mono text-[0.6875rem]', className)}>
      <div className="-my-1 inline-grid grid-cols-[.25rem_1fr_.25rem] grid-rows-[.25rem_1fr_.25rem] align-middle">
        ...
        <div className="font-title m-0.5 bg-app-600 px-1 text-sm font-semibold tracking-wide text-white [grid-area:1/1/4/4]">{t('appName')}</div>
      </div>{' '}
      by{' '}
